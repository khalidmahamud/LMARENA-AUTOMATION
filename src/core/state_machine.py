...
TRANSITION_TABLE: Dict[WorkerState, Set[WorkerState]] = {
    ...
    WorkerState.SELECTING_MODEL: {WorkerState.PASTING, WorkerState.ERROR},
    WorkerState.PASTING: {WorkerState.SUBMITTING, WorkerState.ERROR},
    WorkerState.SUBMITTING: {WorkerState.POLLING, WorkerState.ERROR},
    WorkerState.POLLING: {WorkerState.COMPLETE, WorkerState.ERROR},
